...
The network includes segments for servers, clients, a DMZ with a web server, a secure LAN, and a lab environment with several routers.
...
The DMZ and Secure LAN segments are intentionally configured as /28 subnets, as they require fewer hosts and thus fewer IP addresses.
...
Within the DMZ, an OWASP Broken Web Application Server is deployed as a target for simulated attacks.
...
## 2.3 Port Forwarding
An OWASP Broken Web Application server is deployed in the DMZ. To make this server accessible from the WAN, port forwarding is configured via the pfSense web interface.
<div align="center">
...
<div align="center">
    <img src="https://github.com/j0wittmann/Home-Lab/blob/main/pfSense1%20Clients%20Interface.png" alt="pfSense1 Clients Interface rules" width="700">
</div>
...
<div align="center">
    <img src="https://github.com/j0wittmann/Home-Lab/blob/main/OpenNMS%20Discovery.png" alt="OpenNMS Discovery" width="700">
</div>
...
<div align="center">
    <img src="https://github.com/j0wittmann/Home-Lab/blob/main/SNMPv3%20get-request.png" alt="SNMPv3 get-request" width="750">
</div>
...
<div align="center">
    <img src="https://github.com/j0wittmann/Home-Lab/blob/main/Snort%20Alerts.png" alt="Snort Alerts" width="600">
</div>
...
<div align="center">
    <img src="https://github.com/j0wittmann/Home-Lab/blob/main/Splunk%20UDP%20Flood.png" alt="Splunk UDP Flood search" width="900">
</div>
